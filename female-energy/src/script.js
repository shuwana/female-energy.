artists = ["Alex Mali", "Ari Lennox & J. Cole", "Kali Uchis", "Rihanna", "Sabrina Claudio", "Summer Walker","SZA"];
songName = ["Obviously", "Shea Butter Baby", "telepatía", "Same Ol' Mistakes", "Me In Her", "Riot", "Drew Barrymore"];

albums = ["Sweet & Sour - EP", "Shea Butter Baby", "Sin Miedo (del Amor y Otros Demonios)", "ANTI", "Truth Is", "CLEAR - EP", "Ctrl"];
...
background = ["#89B95F", "#E7AE95", "#EECADE", "#E6E7E9", "#B09492", "#8F9E9B", "#7F83B7"];
